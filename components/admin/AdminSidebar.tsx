...
import { BarChart3, Bell, Users, Settings, ShieldCheck, Activity, Shield } from "lucide-react";
...
const adminMenuItems = [
    ...
    { icon: null, label: "Platform Config", href: "/admin/platform-config", lucide: Settings },
